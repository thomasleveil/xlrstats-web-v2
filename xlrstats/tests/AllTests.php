...
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'xlrstats_AllTests::main');
}
 ...
 */
require_once dirname(__FILE__).'/testCase/GloballogicTest.php';


/**
 * Master Unit Test Suite class for Xlrstats
 * 
 * This top-level test suite class organizes 
 * all class test suite files, 
 * so that the full suite can be run 
 * by PhpUnit or via "pear run-tests -up Xlrstats". 
 */
class Xlrstats_AllTests
{
    ...
    public static function suite()
    {
        $suite = new PHPUnit_Framework_TestSuite(
            'Xlrstats Full Suite of Unit Tests');

        /*
         * You must add each additional class-level test suite name here
         */
        $suite->addTestSuite('GloballogicTest');
 ...
 *           to make this usage meet the PEAR CS... we cannot rename it here.
 */
if (PHPUnit_MAIN_METHOD == 'xlrstats_AllTests::main') {
    xlrstats_AllTests::main();
}
